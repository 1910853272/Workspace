...
%%
sc3_cover_logic = (uz3<825) & (uy3>47) & (uy3<230) & (ux3<521) & (ux3>94) & (z3~=0);
...
curvefit_b_world_sc3 = [0.801604751830293	0.0211590743505880	0.421589378491601];
...
set(get(gca,'colorbar'),'Ticks',0:0.4:2);
