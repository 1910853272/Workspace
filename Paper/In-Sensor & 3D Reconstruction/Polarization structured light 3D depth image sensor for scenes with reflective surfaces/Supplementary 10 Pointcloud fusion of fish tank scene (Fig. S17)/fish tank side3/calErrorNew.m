...
%%
sc3_cover_logic = (uz3<800) & (uy3>5) & (uy3<217) & (ux3<443) & (ux3>185) & (z3~=0);
...
curvefit_b_world_sc3 = [0.757367733386395	0.0290255844060723	0.448422095755233];
...
set(get(gca,'colorbar'),'Ticks',0:0.3:1.8)
