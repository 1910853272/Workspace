...
surf_show_x = linspace(-0.6, 0.8, 10);
surf_show_y = linspace(-0.6, 0.4, 10);
...
set(fig103_xlabel,'Position',[0.1797   -0.7126    0.2457]);
set(fig103_ylabel,'Position',[1.0103   -0.1739    0.2211]);
=======
% run after the plyread.m
%% highlight the extracted glass region
tofit_id = ~logic_id_cam;
