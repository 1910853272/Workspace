...
logical_idmap = (map>0.8);
logical_idmap2 = (map2>0.8); 
...
curvefit_b_world = [0.759571209066798	0.00321348594766134	0.452777172729947];
b = curvefit_b_world;
x1fit = linspace(-0.7,0.7,400); % big enough to cover the glass region
y1fit = linspace(-0.7,0.7,400);
...
floor_filled_map_ptcloud = pointCloud([floor(filled_map_ux+0.08),floor(filled_map_uy+0.08),filled_map_uz]);
