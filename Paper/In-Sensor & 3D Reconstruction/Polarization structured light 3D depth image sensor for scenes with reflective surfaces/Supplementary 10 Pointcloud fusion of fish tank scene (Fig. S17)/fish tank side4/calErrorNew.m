...
%%
sc3_cover_logic = (uz3<800) & (uy3>20) & (uy3<235) & (ux3<535) & (ux3>43) & (z3~=0);
...
curvefit_b_world_sc3 = [0.758215251280222	0.00240749755808172	0.454709326029145];
b_sc3 = curvefit_b_world_sc3;
x3fit = linspace(-0.7,0.7,400);
y3fit = linspace(-0.7,0.7,400);
...
set(get(gca,'colorbar'),'Ticks',0:0.6:1.8)
