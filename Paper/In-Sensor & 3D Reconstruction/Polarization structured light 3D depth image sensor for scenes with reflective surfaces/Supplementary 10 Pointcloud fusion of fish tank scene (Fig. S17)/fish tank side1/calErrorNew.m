...
%%
sc3_cover_logic = (uz3<650) & (uy3>40) & (uy3<303) & (ux3<436) & (ux3>132) & (z3~=0);
...
curvefit_b_world_sc3 = [0.559032365919665	0.245831165402318	0.390889839784804];
...
set(get(gca,'colorbar'),'Ticks',0:0.4:1.6);
