...
surf_show_x = linspace(-0.4,0.8,10);
surf_show_y = linspace(-0.5,0.7,10);
...
%
set(fig103_xlabel,'Position',[0.3354   -0.6352    0.7229]);
set(fig103_ylabel,'Position',[1.1553    0.074    0.7105]);
=======
% run after the plyread.m
%% highlight the extracted glass region
tofit_id = ~logic_id_cam; 
