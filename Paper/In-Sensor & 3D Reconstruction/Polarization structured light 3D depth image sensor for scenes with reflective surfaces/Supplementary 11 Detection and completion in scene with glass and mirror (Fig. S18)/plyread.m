...
logical_idmap = (map>0.5); 
logical_idmap2 = (map2>0.5); 
...
temp_ux1 = ux1;
temp_uy1 = uy1;
logic_id_cam = (tempuz<300) | (substract_uz>1100) | (~logical_erode_id_inmap);
...
curvefit_b_world = [1.04940248069350	-0.236615596367962	-0.0749103719622531];
b = curvefit_b_world;
x1fit = linspace(-0.5,0.9,400); % big enough to cover the glass region
