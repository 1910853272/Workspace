...
%%
sc3_cover_logic = (uz3<1110) & (z3~=0) & (uy3>30) & (uy3<286) & (ux3>249) & (ux3<530);
...
curvefit_b_world_sc3 = [1.04762166328703	-0.239087497388501	-0.0750169387029127];
b_sc3 = curvefit_b_world_sc3;
x3fit = linspace(-0.5,0.9,400);
