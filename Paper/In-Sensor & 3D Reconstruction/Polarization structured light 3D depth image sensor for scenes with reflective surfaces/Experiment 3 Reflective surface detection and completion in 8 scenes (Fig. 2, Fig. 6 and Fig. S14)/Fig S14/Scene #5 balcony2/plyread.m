...
logical_idmap = (logical_idmap) & (mapX1FIT < 496);
logical_idmap2 = (logical_idmap2) & (map_x_vector < 496);
...
temp_ux1 = ux1;
temp_uy1 = uy1;
logic_id_cam = (tempuz<300) | (substract_uz>1000) | (~logical_erode_id_inmap);
...
curvefit_b_world = [0.877676584622843	0.330958309674343	0.159846574156023];
b = curvefit_b_world;
x1fit = linspace(-0.5,0.4,400); % big enough to cover the glass region
y1fit = linspace(-0.5,0.4,400);
...
map_outside_depthBoundary_id = (filled_map_uy<14) | (filled_map_ux > 619);
