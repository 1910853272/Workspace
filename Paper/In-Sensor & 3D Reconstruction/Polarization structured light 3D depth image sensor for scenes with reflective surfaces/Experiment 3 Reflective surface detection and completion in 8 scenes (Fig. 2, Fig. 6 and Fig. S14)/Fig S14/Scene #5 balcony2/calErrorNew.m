...
%%
sc3_cover_logic = (uz3<1000) & (z3~=0) & (uy3<290) & (ux3>140) & (ux3<400);
...
curvefit_b_world_sc3 = [0.876759328836809	0.328730835957296	0.155861860306476];
b_sc3 = curvefit_b_world_sc3;
x3fit = linspace(-0.5,0.4,400);
y3fit = linspace(-0.5,0.4,400);
