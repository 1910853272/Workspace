...
%%
sc3_cover_logic = (uz3<650) & (uy3<346) & (ux3<312) & (ux3>23) & (z3~=0) &...
    ~((uy3>329) & (uy3<347) & (ux3>227) & (ux3<312));
...
curvefit_b_world_sc3 = [0.590849327259503	0.790825374643901	0.398202047731815];
b_sc3 = curvefit_b_world_sc3;
x3fit = linspace(-0.6,0.2,400);
