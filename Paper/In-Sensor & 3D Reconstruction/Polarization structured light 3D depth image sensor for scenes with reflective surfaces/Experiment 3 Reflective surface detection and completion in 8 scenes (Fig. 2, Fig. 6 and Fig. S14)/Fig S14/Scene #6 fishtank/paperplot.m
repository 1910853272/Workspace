...
caxis([350 1250])
hold on
scatter(tofit_x,tofit_y,4,[1 0 0],'filled','s');
hold off
...
surf_show_x = linspace(-0.5, 0.3,10);
surf_show_y = linspace(-0.4, 0.4,10);
...
set(fig103_xlabel,'Position',[-0.0544   -0.4701   -0.1928]);
=======
% run after the plyread.m
%% highlight the extracted glass region
tofit_id = ~logic_id_cam;
...
set(fig103_ylabel,'Position',[0.3902   -0.0091   -0.2236]);