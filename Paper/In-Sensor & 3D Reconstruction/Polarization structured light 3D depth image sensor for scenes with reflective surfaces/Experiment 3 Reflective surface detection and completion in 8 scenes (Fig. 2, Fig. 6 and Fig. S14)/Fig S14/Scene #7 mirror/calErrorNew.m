...
%%
sc3_cover_logic = (uz3<1000) & (z3~=0) & (uy3>102) & (uy3<330) & (ux3>165) & (ux3<340);
...
curvefit_b_world_sc3 = [0.813147765118478	0.225442964483005	-0.119506518054180];
b_sc3 = curvefit_b_world_sc3;
x3fit = linspace(-0.5,0.5,400); 
y3fit = linspace(-0.5,0.5,400);
...
to_cal_id = logical_idmap2 & (~isnan(mykkz3));
figure(23)
imshow(schemepic);
hold on
