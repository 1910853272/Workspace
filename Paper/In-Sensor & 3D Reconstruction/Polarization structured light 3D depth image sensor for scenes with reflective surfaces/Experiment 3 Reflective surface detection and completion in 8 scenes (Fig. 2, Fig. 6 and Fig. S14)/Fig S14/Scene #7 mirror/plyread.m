...
temp_ux1 = ux1;
temp_uy1 = uy1;
logic_id_cam = (((tempuz<300) | (substract_uz>1000))) | (~logical_erode_id_inmap) | (uz1>2000);
...
%% 画平面，世界坐标
curvefit_b_world = [0.813883092239987	0.228472169995649	-0.117430564146656];
b = curvefit_b_world;
x1fit = linspace(-0.5,0.5,400); % big enough to cover the glass region
y1fit = linspace(-0.5,0.5,400);
...
map_outside_depthBoundary_id = (filled_map_uy<3) | (filled_map_ux > 619) |...
    (filled_map_uy>395) | (filled_map_ux < 5);
