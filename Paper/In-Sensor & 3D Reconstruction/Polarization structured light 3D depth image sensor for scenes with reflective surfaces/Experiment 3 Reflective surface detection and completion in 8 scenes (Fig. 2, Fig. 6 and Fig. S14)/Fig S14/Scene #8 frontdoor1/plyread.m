...
%% 画平面，世界坐标
curvefit_b_world = [0.772731961465372	0.0311758095629950	-0.0148468133969419];
b = curvefit_b_world;
x1fit = linspace(-0.7,0.7,600); % big enough to cover the glass region
y1fit = linspace(-0.7,0.7,600);
...
map_outside_depthBoundary_id = (filled_map_uy<5) | (filled_map_ux > 619) |...
    (filled_map_uy>393) | (filled_map_ux < 5);
