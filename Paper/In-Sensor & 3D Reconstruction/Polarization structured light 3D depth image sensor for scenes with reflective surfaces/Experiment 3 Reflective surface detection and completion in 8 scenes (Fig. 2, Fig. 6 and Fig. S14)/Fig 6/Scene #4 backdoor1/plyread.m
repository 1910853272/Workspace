...
temp_ux1 = ux1;
temp_uy1 = uy1;
logic_id_cam = (tempuz<300) | (substract_uz>900) | (~logical_erode_id_inmap);
...
curvefit_b_world = [0.882373818758387	-0.482324926422528	0.132073276046091];
b = curvefit_b_world;
...
colorfx = 802.286865 / 2;
colorfy = 802.286865 / 2;
colorcx = 636.056580 / 2;
colorcy = 398.061676 / 2;

Rmat = [ 0.999401 -0.034303 0.004524
 0.034280 0.999399 0.005066
 -0.004695 -0.004907 0.999977];
Tmat = [-10.489918 1.834440 0.939798] / 1000;
