...
temp_show_logical_id = (b(1) + b(2)*temp_show_x + b(3)*temp_show_y + ...
    b(4)*temp_show_x.^2 + b(5)*temp_show_x.*temp_show_y + ...
    b(6)*temp_show_y.^2 - temp_show_z) <0;
...
temp_surf_Z = b(1) + b(2)*temp_surf_X + b(3)*temp_surf_Y + b(4)*temp_surf_X.^2 + ...
    b(5)*temp_surf_X.*temp_surf_Y + b(6)*temp_surf_Y.^2;
...
set(fig103_xlabel,'Position',[0.0411   -0.2682    0.3212]);
=======
% run after the plyread.m
%% highlight the extracted glass region
tofit_id = ~logic_id_cam;
...
set(fig103_ylabel,'Position',[0.3045   -0.1110    0.3166]);