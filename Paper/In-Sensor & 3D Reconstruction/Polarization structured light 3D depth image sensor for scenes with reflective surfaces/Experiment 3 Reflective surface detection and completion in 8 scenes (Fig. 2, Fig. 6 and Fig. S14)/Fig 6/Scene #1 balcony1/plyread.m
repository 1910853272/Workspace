...
curvefit_b_world = [0.792861490036366	-0.289715701055176	0.368165942675294]; 
b = curvefit_b_world;
x1fit = linspace(-0.2,0.7,400); % big enough to cover the glass region
y1fit = linspace(-0.4,0.24,400);
...
map_outside_depthBoundary_id = (filled_map_uy<5) | (filled_map_ux > 619);
