...
%%
sc3_cover_logic = (uz3<900) & (z3~=0) & (uy3<240) & (ux3>260);
...
curvefit_b_world_sc3 = [0.793030405248835	-0.289003515850135	0.374313839668602];
b_sc3 = curvefit_b_world_sc3;
x3fit = linspace(-0.2,0.7,400);
y3fit = linspace(-0.4,0.24,400);
