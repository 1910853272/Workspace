...
class model():
    ...
    def draw1(self,preds,preds2,preds3,start2,start3,steps,nj):
        ...
        for dimension in range(args.V):
            ...
            be = start2-ds
            la = start2+steps+ds
            ax11.plot(np.arange(be,la), X[Nj,nj,be:la,dimension],'k-',markersize=7,label='True',linewidth=8)
            #ax11.plot(np.arange(be,la), preds[Nj,nj,be-warm_up:la-warm_up,dimension],'y-x',markersize=5,label='One-step prediction')
            ax11.plot(np.arange(start2,start2+steps), preds2[Nj,nj,:,dimension],'r--',
                      linewidth=3,markersize=3,label='Multi-step interpolation prediction')
            ...
            be = start3-ds
            la = start3+steps+ds
            ax12.plot(np.arange(be,la), X[Nj,nj,be:la,dimension],'k-',markersize=7,label='True',linewidth=8)
            #ax12.plot(np.arange(be,la), preds[Nj,nj,be-warm_up:la-warm_up,dimension],'y-x',markersize=5,label='One-step prediction')
            ax12.plot(np.arange(start3,start3+steps), preds3[Nj,nj,:,dimension],'y--',
                      linewidth=3,markersize=3,label='Multi-step extrapolation prediction')
    ...
    def draw_FHN(self,preds,preds2,preds3,start2,start3,steps,nj):    
        ...
        #ax1.plot(X[Nj,nj,warm_up:,0],X[Nj,nj,warm_up:,1],'k-',markersize=10,label='True')
        #ax1.plot(X[Nj,nj,start2-d:start2+steps+d,0],X[Nj,nj,start2-d:start2+steps+d,1],'bo-',markersize=10,label='Ground truth',linewidth=1)
        ax1.plot(X[Nj,nj,start3-d:start3+steps+d,0],X[Nj,nj,start3-d:start3+steps+d,1],'bo-',markersize=10,label='Ground truth',linewidth=1)

        #ax1.plot(preds2[Nj,nj,:steps,0],preds2[Nj,nj,:steps,1],'ro--',markersize=15, markeredgecolor = 'r', markerfacecolor=(0, 0, 0, 0),label='Multi-step interpolation prediction',linewidth=1)
        ax1.plot(preds3[Nj,nj,:steps,0],preds3[Nj,nj,:steps,1],'ro--',markersize=15, markeredgecolor = 'r', markerfacecolor=(0, 0, 0, 0),label='Multi-step extrapolation prediction',linewidth=1) 
        
        ax1.tick_params(labelsize=30)
        ax1.set_xlabel(r'$x_i^1$',size=40)
        ax1.set_ylabel(r'$x_i^2$',size=40)
    ...
    def draw_3d(self,preds,preds2,preds3,start2,start3,steps,nj):    
        ...
        ax1.grid(False)
        ax1.plot(X[Nj,nj,start2-d:start2+steps+d,0],X[Nj,nj,start2-d:start2+steps+d,1],X[Nj,nj,start2-d:start2+steps+d,2],'bo-',markersize=10,label='Ground truth',linewidth=3)
        #ax1.plot(X[Nj,nj,start3-d:start3+steps+d,0],X[Nj,nj,start3-d:start3+steps+d,1],X[Nj,nj,start3-d:start3+steps+d,2],'bo-',markersize=10,label='Ground truth',linewidth=3)

        ax1.plot(preds2[Nj,nj,:steps,0],preds2[Nj,nj,:steps,1],preds2[Nj,nj,:steps,2],'ro--',markersize=15, markeredgecolor = 'r', markerfacecolor=(0, 0, 0, 0),label='Multi-step prediction')
        #ax1.plot(preds3[Nj,nj,:steps,0],preds3[Nj,nj,:steps,1],preds3[Nj,nj,:steps,2],'ro--',markersize=15, markeredgecolor = 'r', markerfacecolor=(0, 0, 0, 0), label='Multi-step prediction')
        
        ax1.tick_params(labelsize=30)
        ax1.set_xlabel(r'$x_i^1$',size=30)
        ax1.set_ylabel(r'$x_i^2$',size=30)
        ax1.set_zlabel(r'$x_i^3$',size=30)
        #ax1.legend(prop=font1)
    ...
    def draw3(self):
        ...
        ax1.grid(False)
        ax1.plot(X[Nj,nj,:,0],X[Nj,nj,:,2],X[Nj,nj,:,3],'k-',markersize=13,label='True',linewidth=3)
